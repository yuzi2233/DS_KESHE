...
//    GridPane Mpane;
    ...
    InPane(int length,int ave, int line , int i,ArrayList stations,ArrayList price)
    {
        ...
        pa1=creat_st(ave,i,stations,adjust);
        pa2=creat_pr(ave,i,price,adjust);
        Mpane.getChildren().add(pa1);
        Mpane.getChildren().add(pa2);
    }
    VBox creat_st(int ave,int i,ArrayList stations,int adjust)
    {
    ...
    VBox creat_pr(int ave,int i,ArrayList price,int adjust)
    {
