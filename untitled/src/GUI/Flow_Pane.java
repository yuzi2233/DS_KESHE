...
public class Flow_Pane extends Application {
   ...
   int page_flag=0;
    ...
    public static void timer1(GridPane pane,Flow_Pane_every lines) {
    ...
    {
        lines=new Flow_Pane_every(ma.subway,pic);
        pane1=new GridPane();
        for (int i = 0; i < 3; i++) {
        ...
        public void handle(ActionEvent event) {
            ...
            if(a.getText().equals("生成价目表"))
            {
                ...
                try {
                    ...
                    Rectangle_Pane price_pane=new Rectangle_Pane(mm);
